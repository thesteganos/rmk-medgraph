...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    print("The next step is to build the tag hierarchy. This is a slow,")
    print("expensive, and data-intensive process.")
    print("It is commented out by default to prevent accidental execution.")
    print("="*50)
    
    # UNCOMMENT THE FOLLOWING LINE TO RUN THE HIERARCHY BUILD
